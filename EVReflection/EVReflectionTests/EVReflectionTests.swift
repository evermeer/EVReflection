...
class EVReflectionTests: XCTestCase {
    ...
    */
    ...
    func testNSNumber() {
        ...
        let value1 = EVReflection.valueForAny("", key: "", anyValue: test1)
        XCTAssert(value1.value as? NSNumber == NSNumber(long: 458347978508), "Values should be same for type NSNumber")
        
        let test2:Float = 458347978508
        let value2 = EVReflection.valueForAny("", key: "", anyValue: test2)
        XCTAssert(value2.value as? NSNumber == NSNumber(float: 458347978508), "Values should be same for type Float")

        let test3:Double = 458347978508
        let value3 = EVReflection.valueForAny("", key: "", anyValue: test3)
        XCTAssert(value3.value as? NSNumber == NSNumber(double: 458347978508), "Values should be same for type Double")

        let test4:Int64 = Int64.max
        let value4 = EVReflection.valueForAny("", key: "", anyValue: test4)
        //let x:NSNumber = NSNumber(longLong: Int64.max)
        XCTAssert(value4.value as? NSNumber == NSNumber(longLong: Int64.max), "Values should be same for type Int64")

        let test5:Int32 = Int32.max
        let value5 = EVReflection.valueForAny("", key: "", anyValue: test5)
        XCTAssert(value5.value as? NSNumber == NSNumber(int: Int32.max), "Values should be same for type Int32")

        let test6:Int = Int.max
        let value6 = EVReflection.valueForAny("", key: "", anyValue: test6)
        XCTAssert(value6.value as? NSNumber == NSNumber(integer: Int.max), "Values should be same for type Int64")
    }
