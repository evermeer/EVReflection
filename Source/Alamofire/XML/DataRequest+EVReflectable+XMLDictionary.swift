...
public extension DataRequest {
     ...
     */
    @discardableResult
    func responseObjectFromXML<T: NSObject>(queue: DispatchQueue? = nil, keyPath: String? = nil, mapToObject object: T? = nil, completionHandler: @escaping (DataResponse) -> Void) -> Self where T: EVReflectable{
