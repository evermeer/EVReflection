...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/EVReflection-f652fe09/EVReflection.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Xml2Dictionary-OSX/Xml2Dictionary.framework"
fi
