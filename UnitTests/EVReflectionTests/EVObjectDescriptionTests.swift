...
class EVObjectDescriptionTests: XCTestCase {
    ...
    */
    override func setUp() {
        ...
        XCTAssert(bundle == "UnitTestsOSX" || bundle == "UnitTestsiOS" || bundle == "UnitTestsTVOS", "Pass")
    }
    ...
    */
    ...
    func testEVObjectDescription() {
        ...
        // For now these only succeed because we assume a function name will have an aditional string 
